...
import Exceptions.InvalidRotatorException;
...
public class DisplayObjectWithTick extends TickObject implements Saveable {
    ...
    public DisplayObjectWithTick(DisplayObjectWithTick d){
        super(50,d.l);
        this.name =d.name;
    ...
    public DisplayObjectWithTick(String name, Level l){
        super(50,l);
        this.name = name;
    }

    //EFFECT: Construct a display object
    public DisplayObjectWithTick(Vector_3D location, Vector_3D[] points, int[][] lines, String name, Rotator_3D r, Level l){
        super(50,l);
        if(location==null){
...
//            }
    ...
    //EFFECTS: do something when clock ticks
    public void tick(){
    ...
    public void save(String filename) {
        try {
            ...
            printer.printMessage("Can't Save File");
        }
    }
